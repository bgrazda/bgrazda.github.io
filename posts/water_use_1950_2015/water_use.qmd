---
title: "Understanding yearly freshwater withdrawals in the US from 1950-2015"
author: "Brooke Grazda"
date: "2023-11-15"
output: html_document
image: water_use.jpg
categories: [USGS, water, R]
---
 
The United States Geological Survey (USGS) has reported daily water use since as early as the 1950s. There is a plethora of knowledge that you are able to extract in each of these databases, indubitably. For this case study, I will examine daily freshwater withdrawal trends across sector, state, and source.
...
**Table 1: "Sets" of data, for which each of the sets have ALL column tags in common. Data from USGS (1950-2015). The data for this project are available from the [United States Geological Survey](https://water.usgs.gov/watuse/data/) for years 1950-2015.**
...
### Plot for timeseries of sectoral withdrawals
...
```
Note: In this [USGS plot](https://www.usgs.gov/special-topics/water-science-school/science/total-water-use-united-states), thermoelectricity is shown to have the highest overall amount of freshwater withdrawals. This may be due in part to there being no indication of the type of water that is used. For example, this plot could account for both withdrawals and deliveries within the thermoelectric sector.
